  ...
  return (
    ...
    <article>
      ...
      <div className="theme-doc-markdown markdown">
        ...
        <p>
          C4GT Mentoring Program has been conceptualized as a summer coding
          program to create a close-knit community that can build and contribute
          to global digital public goods.
        </p>
        <ul>
          <li>
            An opportunity for college students and working professionals in
            India to experience the GovTech space
          </li>
          ...
          <li>
            Shortlisted contributors will receive mentorship from leading
            practitioners in GovTech ecosystem
          </li>
        </ul>
